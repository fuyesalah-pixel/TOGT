...
export function FaqSection() {
  ...
  return (
    <section
      id="faq"
      className="relative py-20 md:py-28 overflow-hidden bg-gradient-to-br from-white via-gray-50/60 to-white"
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(31,103,177,0.04) 0%, rgba(255,147,0,0.03) 100%)" }}
      />
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-[#FF9300] font-bold tracking-[0.25em] text-xs uppercase">FAQ</span>
          ...
          <p className="mt-4 text-sm md:text-base text-gray-500 max-w-md mx-auto">
        ...
        <Accordion className="w-full space-y-3 md:space-y-4">
          {faqItems.map((item, index) => (
            ...
            >
              ...
              >
                {/* Left accent line — grows when open */}
                ...
                <AccordionTrigger className="w-full flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 text-left hover:no-underline [&>svg]:hidden">
                  <span className="flex items-center gap-3 md:gap-4 flex-1 min-w-0">
                    {/* Icon circle */}
                    <span
                      className="flex-shrink-0 w-9 h-9 md:w-10 md:h-10 rounded-full flex items-center justify-center transition-all duration-300
